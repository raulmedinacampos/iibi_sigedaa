...
$header .= '<td><p><strong>Inventario de Baja Documental</strong></p></td>';
...
$html .= '<p><strong>Número de baja documental:</strong> ______ <strong></p>';
...
$html .= '<div>';
$html .= '<div class="firma primero cuatro">';
$html .= '<p>AUTORIZA</p>';
$html .= '<p class="cargo">RESPONSABLE DEL ÁREA PRODUCTORA DE LA DOCUMENTACIÓN</p>';
$html .= '<p class="nombre">NOMBRE Y FIRMA</p>';
$html .= '</div>';  //.firma1

$html .= '<div class="firma cuatro">';
$html .= '<p>ELABORÓ</p>';
$html .= '<p class="cargo">RESPONSABLE DEL ARCHIVO DE TRÁMITE</p>';
$html .= '<p class="nombre">NOMBRE Y FIRMA</p>';
$html .= '</div>';  //.firma2

$html .= '<div class="firma cuatro">';
$html .= '<p>ELABORÓ</p>';
$html .= '<p class="cargo">RESPONSABLE DEL ARCHIVO DE CONCENTRACIÓN</p>';
$html .= '<p class="nombre">NOMBRE Y FIRMA</p>';
$html .= '</div>';  //.firma3

$html .= '<div class="firma ultimo cuatro">';
$html .= '<p>Vo. Bo.</p>';
$html .= '<p class="cargo">TITULAR DE LA UNIDAD UNIVERSITARIA</p>';
$html .= '<p class="nombre">NOMBRE Y FIRMA</p>';
$html .= '</div>';  //.firma4
$html .= '</div>';  //div
